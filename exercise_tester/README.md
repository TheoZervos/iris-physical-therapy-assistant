...
A disjoint program designed to help in the creation and testing of exercises for the Iris application.

---

## ✨ Overview

This is a pure Python service built on Google's **MediaPipe Tasks Vision API** for high-performance, real-time skeletal tracking. It captures a live camera feed and maps **33 human body landmarks** (shoulders, elbows, joints, etc.) with high accuracy and low latency, running natively on CPU.
